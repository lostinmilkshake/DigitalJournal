...
namespace MoodleApiWrapper
{
    public class MoodleApiClient : IMoodleApiClient
    {
        ...
        public MoodleApiClient(HttpClient httpClient, 
            IOptions<Moodle> options)
        {
        ...
        /// <returns></returns>
        public async Task<ApiResponse<Users>> GetUsers(string criteria_key0, string criteria_value0,
            string criteria_key1 = "", string criteria_value1 = "")
        {
            ...
            return await getAsync<Users>(query);
        }
